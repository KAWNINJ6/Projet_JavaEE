...
<div class="container">
    <div class="row container d-flex justify-content-center">
        <div class="col-md-6 col-lg-4">
            <form class="card" method="post" action="retour">
                <h5 class="card-title fw-400">Espace Retour</h5>
                <div class="card-body">
                    <div class="form-group">
                        <select class="form-control" name="docRendu">
                            <option value="0">Séléctioner un document</option>
                            <c:forEach var="docRendu" items="${docRendus}">
                                <option value="${docRendu.toString().split("/")[0]}">${docRendu.toString().split("/")[1]}</option>
                            </c:forEach>
                        </select>
                    </div>
                    <div class="form-group">
                        <button class="btn btn-block btn-bold btn-primary">Rendre</button>
                    </div>
